...
module "iam_roles" {
  ...
  tofu_state_bucket         = "fundamentals-of-devops-tofu-state-968196829199"
  tofu_state_dynamodb_table = "fundamentals-of-devops-tofu-state-968196829199"
}
